...
use rbchat::knowledge::DataSource::Context;
use rbchat::knowledge::{ConnectionMode, EmbeddingData, KnowledgeStore, StoreBuilder};
...
fn process_files(sender: Sender<Job>, persona: Persona) -> Result<(), Box<dyn Error>> {
